...
public class BookingController {
    ...
    public ResponseEntity<?> cancelBookingByConfirmationCode(@PathVariable String confirmationCode) {
        try {
            bookingService.cancelBookingByConfirmationCode(confirmationCode);
